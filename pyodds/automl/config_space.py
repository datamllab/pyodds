...
CUMULATIVE_SEARCH_SPACE = hp.choice('classifier_type',[
	{
		'type':'iforest','contamination':0.5,'n_estimators':100,
		'max_samples':"auto",
		'max_features':1.,
	...
	{
		'type':'lof',
		'contamination':0.5,'n_neighbors':20, 'algorithm':'auto', 'leaf_size':30,'metric':'minkowski', 'p':2, 'metric_params':None, 'novelty':True,
	},
	{
		'type':'robustcovariance',
		'random_state':141,'store_precision':True, 'assume_centered':False,'support_fraction':None, 'contamination':0.1,
	},
	{
		'type':'staticautoencoder',
		'contamination':0.5,'epoch':100,'dropout_rate':0.2,
		'regularizer_weight':0.1,'activation':'relu','kernel_regularizer':0.01,
		'loss_function':'mse','optimizer':'adam'
	},
	{
		'type':'cblof',
		'contamination':0.5,'n_clusters':8, 'clustering_estimator':None,
		'alpha':0.9, 'beta':5,'use_weights':False, 'random_state':141,'n_jobs':1,
	},
	{
		'type':'knn',
		'contamination':0.5,'n_neighbors':5, 'method':'largest','radius':1.0,
		'algorithm':'auto', 'leaf_size':30, 'metric':'minkowski', 'p':2, 'metric_params':None, 'n_jobs':1,
	},
	{
		'type':'hbos',
		'contamination':0.5, 'n_bins':10, 'alpha':0.1, 'tol':0.5,
	},
	{
		'type':'sod',
		'contamination':0.5,'n_neighbors':20,'ref_set':10,'alpha':0.8,
	},
	{
		'type':'pca',
		'contamination':0.5, 'n_components':None, 'n_selected_components':None,
		'copy':True, 'whiten':False,'svd_solver':'auto','tol':0.0,
		'iterated_power':'auto','random_state':141,'weighted':True, 'standardization':True,
	},
	{
		'type':'dagmm',
		'contamination':0.5,'num_epochs':10, 'lambda_energy':0.1,
		'lambda_cov_diag':0.005, 'lr':1e-3, 'batch_size':50, 'gmm_k':3,
		'normal_percentile':80, 'sequence_length':30, 'autoencoder_args':None,
	},
	# {
	# 	'type':'luminol','contamination':0.5
	# },
	{
		'type':'autoencoder',
		'contamination':0.5,'num_epochs':10, 'batch_size':20, 'lr':1e-3,
	    'hidden_size':5, 'sequence_length':30, 'train_gaussian_percentage':0.25,
	},
	{
		'type':'lstm_ad',
		'contamination':0.5,'len_in':1, 'len_out':10, 'num_epochs':10,
